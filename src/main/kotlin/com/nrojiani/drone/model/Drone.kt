...
/** 6am - 10pm */
@JvmField
val DRONE_DELIVERY_OPERATING_HOURS = TimeInterval(LocalTime.parse("06:00:00"), Duration.ofHours(16))

/** 10pm - 6am */
@JvmField
val DRONE_DELIVERY_OFF_HOURS = TimeInterval(LocalTime.parse("22:00:00"), Duration.ofHours(8))
